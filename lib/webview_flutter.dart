...
/// custom
typedef void WebChromeClientCallback(String url, String title);
...
class WebView extends StatefulWidget {
  ...
  ///custom
  final WebChromeClientCallback webChromeClient;
...
WebSettings _webSettingsFromWidget(WebView widget) {
  return WebSettings(
    ...
    hasWebChromeClient: widget.webChromeClient != null,
...
class _PlatformCallbacksHandler implements WebViewPlatformCallbacksHandler {
  ...
  @override
  void webChromeClient(String url, String title) {
    if (_widget.webChromeClient != null) {
      _widget.webChromeClient(url, title);
    }
  }
}
...
class CookieManager {
  ...
  /// set cookies
  Future<void> setCookies(String url, String cookies) => WebView.platform.setCookies(url, cookies);
}
